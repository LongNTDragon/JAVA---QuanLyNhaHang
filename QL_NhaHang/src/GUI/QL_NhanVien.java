...
public class QL_NhanVien extends javax.swing.JFrame {
    ...
    public void loadData(){
        ...
        try {
            ResultSet resultSet = dao.selectData("exec sp_SelectNV");
    ...
    private void loadCBOChucVu(String ten)
    {
        ...
        int index = 0;
        try {
            ResultSet rs = dao.selectData("SELECT * FROM CHUCVU");
            while (rs.next())
            {
    ...
    private void initComponents() {
        ...
        lblMaNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lblMaNhanVien.setText("Mã nhân viên:");

        txtMaNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N

        lblTenNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lblTenNhanVien.setText("Tên nhân viên:");

        txtTenNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N

        lblSDTNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        lblChucVuNhanVien.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
            ...
            .addGroup(pnlThongTinNhanVienLayout.createSequentialGroup()
                ...
                .addGroup(pnlThongTinNhanVienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlThongTinNhanVienLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtTenNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(pnlThongTinNhanVienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlThongTinNhanVienLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnLamMoi, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlThongTinNhanVienLayout.createSequentialGroup()
                        .addComponent(txtSDTNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnSuaNhanVien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/update.png"))); // NOI18N
        ...
        pnlChucNangNhanVienLayout.setVerticalGroup(
            ...
            .addGroup(pnlChucNangNhanVienLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnSuaNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlDSNhanVienLayout.setVerticalGroup(
            pnlDSNhanVienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(spnDSKhachHang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 393, Short.MAX_VALUE)
        );
    ...
    private void btnThemNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemNhanVienActionPerformed
        ...
        boolean validate_maNV = daoNV.validate_ID(txtMaNhanVien.getText());
        boolean validate_SDT = daoNV.validate_PhoneNumber(txtSDTNhanVien.getText(), txtMaNhanVien.getText());
        ...
        {
            daoNV.insertNV(nhanvien);
            dao.createUser(nhanvien.getMaNV(), nhanvien.getSDT().substring(nhanvien.getSDT().length() - 3));
            dao.addUserToRole(nhanvien.getMaNV());
            refreshForm();
        }
    ...
    public Integer updateSearchedData()
    {
        ...
        int count=0;
        try {
            ResultSet resultSet =daoNV.findNV(txtTimKiem.getText());
...
//        }
    ...
    private void btnTimNhanVien1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimNhanVien1ActionPerformed
        ...
        txtMaNhanVien.setText(daoNV.Auto_Increasement_MaNV());
    ...
    private void btnXoaNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaNhanVienActionPerformed
        ...
        else
        {
            ...
            if(reply==JOptionPane.YES_OPTION)
            {
                ...
                {
                    String maNV = (String)tblDSNhanVien.getValueAt(rows[i], 0);
                    if(maNV.equals("NV0001"))
                        JOptionPane.showMessageDialog(rootPane, "Bạn không thể xóa nhân viên này.");
                    else
                    {
                        if(daoNV.deleteNV(maNV)==1)
                        {
                            total++;
                            dao.dropLogin(maNV);
                            dao.dropUser(maNV);
